...
/**
 * Makes the FTP authentication sequence
 */
...
exports.get = function (opt, file, cb) {
	...
	client.on('stream', function (stream) {
		...
		if (file === null) { // buffer the data
			...
			// TODO: call fsync with the previous overlycomplicated wrapper, avoids the ENOENT crap
			console.error('Warning: the pipe usage may lead to ENOENT errors.');
